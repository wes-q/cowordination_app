...
const GameBoard = ({ randomWords, wordsToGuess, players, currentUser, roomCode, currentGameID, currentRound, isSubmitted, setIsSubmitted, hasEveryoneSubmitted, setHasEveryoneSubmitted }) => {
    ...
    const submittedButtonCSS = useRef(`bg-green-400 hover:cursor-not-allowed ml-2 w-44 mt-4 hover:ring-cyan-500 hover:ring-1 hover:shadow-md text-white font-bold py-2 px-4 rounded focus:outline-none mr-2 transition-all`);
    ...
    const notReadyForSubmissionButtonCSS = useRef(`bg-neutral hover:cursor-not-allowed dark:bg-primaryDark ml-2 w-44 mt-4 hover:ring-cyan-500 hover:ring-1 hover:shadow-md text-white font-bold py-2 px-4 rounded focus:outline-none mr-2 transition-all`);

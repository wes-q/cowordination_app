...
const RoomPage = ({ currentUser, players, randomWords, wordsToGuess, currentGameID, currentRound, isGameStarted, isSubmitted, setIsSubmitted, hasEveryoneSubmitted, setHasEveryoneSubmitted }) => {
